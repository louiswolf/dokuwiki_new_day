...
include(dirname(__FILE__).'/tpl_functions.php');
...
<head>
  ...
  <link rel="shortcut icon" href="<?php echo dirname(__FILE__) ?>images/favicon.ico" />

  <?php /*old includehook*/ @include(dirname(__FILE__).'/meta.html')?>

	<script src="<?php echo dirname(__FILE__) ?>js/scriptaculous.js" type="text/javascript"></script>
</head>
...
<div class="sideandpage" >
	<?php /* if (tpl_getConf('btl_sidebar_position') == "right") {  ?>
	      <div class="<?php (tpl_getConf('btl_sidebar_position') == "right" ? "mainleft" : "mainright") ?>">
	        <div class="page">
	          <!-- wikipage start -->
	          <?php tpl_content()?>
	          <!-- wikipage stop -->
...
?>
		...
		<?php if (tpl_getConf('btl_hide_user_actions') == 0) { ?>
			...
			<div id="userActionTableId" <?php action_group_status('user'); ?> ><div>
		        <table cellspacing="0" cellpadding="2" border="0" width="100%" >
				<tr><td>
					<?php if (is_action_enabled('media')) { ?><div class="smallpadding"><?php tpl_actionlink('media')?></div><?php } ?>
					<?php if (is_action_enabled('login')) { ?><div class="smallpadding"><?php tpl_actionlink('login')?>
						<?php 
						...
						<tr><td>
					<?php } ?>
					<?php if (is_action_enabled('profile') && $_SERVER['REMOTE_USER']) { ?><div class="smallpadding"><?php tpl_actionlink('profile') ?></div></td></tr><tr><td><?php } ?>
	...
	<?php /* if (tpl_getConf('btl_sidebar_position') == "left") { */ ?>
	      <div class="<?php echo(tpl_getConf('btl_sidebar_position') == "right" ? "mainleft" : "mainright") ?>" >

	        <div class="<?php echo(tpl_getConf('btl_sidebar_position') == "right" ? "pagewrapperleft" : "pagewrapperright") ?>">
	          <div class="page">
        	    <!-- wikipage start -->
	            <?php tpl_content()?>
	            <!-- wikipage stop -->
  ...
  <div class="stylefoot">
   ...
   <?php /*old includehook*/ @include(dirname(__FILE__).'/pagefooter.html')?>
    ...
    <div class="bar" id="bar__bottom">
       ...
       <img style="float:right" class="footer_border" src="<?php dirname(__FILE__) . '/images/footer_image_right.png' ?>" alt=""/> 
     <div class="clearer"></div>
    </div>
